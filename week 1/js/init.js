...
let marker2 = L.marker([34.083280, -118.073870]).addTo(map) // (3)!
		.bindPopup('<b>Rose City Pizza in Rosemead, CA<b> <br> 3588 Rosemead Blvd, Rosemead, CA 91770 <br> I bet you have never had pizza like this, this pizzeria offers unique toppings based off of neighboring cuisines! I recommend getting a half Island Shrimp and half Birria or Taiwanese Popcorn Chicken pizza.')
		.openPopup();

let marker3 = L.marker([34.0832, -118.07386]).addTo(map) // (3)!
